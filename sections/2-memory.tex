...
% We'll instead refer to it by its hexadecimal form: 0x0A0B0C0D. The largest byte is 0A,
...
% ---------------------------
\newcommand{\currentexample}{$168496141_{10}$ = \hex{0A0B0C0D}}
\begin{frame}{\currenttitle}
...
% Lilliputian has also made it into the English dictionary and has the meaning tiny or trivial.
  \textbf{Endianness} indicates the order in which memory is written and read
\end{frame}
