...
% Computer scientists in the 80s recognized the limitations of traditional encodings
% such as ASCII and its derivatives.
% Thus, Unicode was designed with the explicit goal of unifying text processing across all
% languages.
%
...
% moder times and avoids the caveats of ASCII and similar encodings to do that, but how is
% that accomplished?
%
% Distinction #1:
...
\begin{frame}{\currenttitle}
% So how does Unicode's design solve the problems that plague ASCII?
%
% Let's look at the first problem we mentioned: character coverage.
% ASCII was sufficient for basic English, and extended regional variants covered some accented
