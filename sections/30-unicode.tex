...
\begin{frame}{\currenttitle}
% The Unicode standard defines the Universal Coded Character Set (UCS), a superset of the ISO
% 8859-1 character set, that contains most of the characters in most modern scripts.
...
% codepoint.
%
% For the Universal Coded Character Set, the allowed codepoint values range from 0 to 10FFFF
% in hex.
...
% ---------------------------
\begin{frame}[standout]
% So, we've basically solved our first two bullet points.
...
%
% The UCS includes the 'micro sign' and the Greek small letter 'mu', and both
% look like this u with a tail.
...
% We need to look at them at a deeper level, and that is the semantic level, which gives
% us graphemes.
\end{frame}
...
% separately.
%
% However, fonts are way out of scope for this talk, so that's all we'll say about that.
\end{frame}
...
%
% However, memory is generally considered in powers of 2, so most of the relevant Unicode
% encodings will work with 4 bytes.
\end{frame}
...
% These are all non-trivial questions and operations.
  ...
  \begin{figure}
    \begin{bytefield}{48}
      ...
      \bitboxes{1}{11100111 10101100 10010001 01110111 11000010 10100010}
    \end{bytefield}
