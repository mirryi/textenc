...
% ---------------------------
\renewcommand{\currenttitle}{Use a standard library}
\begin{frame}{\currenttitle}
...
% ---------------------------
\renewcommand{\currenttitle}{Let's talk Java}
\begin{frame}{\currenttitle}
% Let's talk about Java.
  Java \texttt{String}'s are stored internally using UTF-16BE.
\end{frame}

% ---------------------------
\renewcommand{\currenttitle}{What about Python?}
\begin{frame}{\currenttitle}
\end{frame}

% ---------------------------
\renewcommand{\currenttitle}{C and C++}
\begin{frame}{\currenttitle}
\end{frame}
